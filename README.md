<!--
  ...
  version number: 1.1 (Vite & Docker update)
...
- Model: GitHub Copilot, GPT-4, OpenAI
- Version: GPT-4.1
- Date: 2025-06-06
...
```
+-----------------------------------------------------------------------------------------------------------------+
| Browser (User Interface - Main UI Thread - src/App.tsx)                                                         |
| ... (internal logic similar to previous version) ...                                                            |
| - Environment variables for API keys are now typically prefixed with `VITE_` (e.g., `import.meta.env.VITE_API_KEY`) |
| - Worker script (`public/worker.js`) is fetched.                                                                |
+----------------------------------------------------^--------------------------------------------------------+ |
...
+------------------------------------------------------|----------------------------------------------------------+
                                                       ...
                                                       v
+-----------------------------------------------------------------------------------------------------------------+
| Web Worker (Background Thread - public/worker.js)                                                               |
| ... (internal logic similar to previous version) ...                                                            |
+-----------------------------------------------------------------------------------------------------------------+
```
